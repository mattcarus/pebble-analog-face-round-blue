...
static void window_load(Window *window) {
  ...
  s_day_label = text_layer_create(PBL_IF_ROUND_ELSE(
    ...
    GRect(46, 114, 27, 20)));
  text_layer_set_text(s_day_label, s_day_buffer);
  text_layer_set_background_color(s_day_label, GColorOxfordBlue);
  text_layer_set_text_color(s_day_label, GColorCeleste);
  ...
  s_num_label = text_layer_create(PBL_IF_ROUND_ELSE(
    ...
    GRect(73, 114, 18, 20)));
  text_layer_set_text(s_num_label, s_num_buffer);
  text_layer_set_background_color(s_num_label, GColorOxfordBlue);
  text_layer_set_text_color(s_num_label, GColorCeleste);
